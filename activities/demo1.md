...
1. **Create a new Topology with a single Resource added from Velocity Inventory**
  ...
  -- below you can find a sample Topology for training purposes ([demo #1] Topology)
2. **Reserve Topology**  
